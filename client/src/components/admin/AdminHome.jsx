...
import ElectionRequestManager from "./ElectionRequestManager";
import AdminProfilePage from "./AdminProfilePage";   // editable profile form
...
export default function AdminHome() {
  ...
  // Password change states (for modal)
  ...
  const menuItems = [
    ...
    { id: "RequestElection", label: "Request Election", icon: Vote },
  ...
  const renderContent = () => {
    switch (activeTab) {
      ...
      case "candidates": return <ContestantManagement />;
      case "elections": return <ElectionManager />;
      case "vote-verifier": return <VoteVerifier />;
      case "finance": return <FinanceView />;
      case "RequestElection": return <ElectionRequestManager />;
  ...
  return (
    <div className="flex min-h-screen bg-gray-50 text-gray-800">
      ...
      <main className="flex-1 flex flex-col min-h-screen">
        ...
        <div className="p-2 flex-1 overflow-auto">{renderContent()}</div>
      </main>
