        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full h-11 bg-[#12121b] border border-white/10 rounded-xl px-4 text-sm text-white outline-none focus:border-violet-500"
              placeholder="Your campaign slogan"
            />
          </div>

          <div>
            <label className="block text-sm text-gray-300 mb-1">Manifesto</label>
            <textarea
              name="manifesto"
              rows={4}
              value={form.manifesto}
              onChange={handleChange}
              className="w-full bg-[#12121b] border border-white/10 rounded-xl px-4 py-3 text-sm text-white outline-none focus:border-violet-500 resize-none"
          ...
          <div>
            <label className="block text-sm text-gray-300 mb-1">Twitter Handle</label>
            <input
              type="text"
              name="twitterHandle"
          ...
          <div className="flex justify-end gap-3 pt-2">
            ...
            <button
              type="submit"
              disabled={loading}
              className="flex items-center gap-2 px-6 py-2.5 rounded-xl bg-gradient-to-r from-violet-600 to-indigo-600 hover:from-violet-700 hover:to-indigo-700 disabled:opacity-70 transition text-white text-sm font-semibold"
            >
