...
//             <Vote size={22} />
//           </div>
//           <span>Vote<span className="text-violet-400">Up</span></span>
//         </NavLink>

//         {/* Nav Links */}
//         <nav className="hidden items-center gap-10 text-sm md:flex">
//           <NavLink to="/" end className={linkClass}>Home</NavLink>
//           <NavLink to="/voter/elections" className={linkClass}>Elections</NavLink>
//           <NavLink to="/voter/results/0" className={linkClass}>Results</NavLink>
